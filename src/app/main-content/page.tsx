...
// Используем настройки с лимитированной динамичностью вместо force-dynamic
export const dynamic = "auto";
export const revalidate = 3600; // Обновление каждый час

export default async function Home() {
  // Явно указываем тип для recentArticles
  let recentArticles: any[] = [];
  try {
    recentArticles = await getRecentArticles(3);
  } catch (error) {
    console.error("Ошибка при получении последних статей:", error);
    // Продолжаем работу даже при ошибке получения статей
  }
