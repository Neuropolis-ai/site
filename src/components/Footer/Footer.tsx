                    ...
                    <div className="flex flex-col md:flex-row justify-between gap-8 md:gap-[300px]">
                        ...
                        <div className="w-full md:w-1/3 mb-8 md:mb-0 max-[425px]:mb-0">
                            <div className="flex items-center mb-4">
                                <Image src={isDark ? logo : blackLogo} className='w-[120px] h-[48px] object-cover' alt="Noctis AI" width={120} height={48} />
                            </div>
                            <p className={`mb-6 max-[425px]:text-[14px] max-[425px]:mb-0 ${isDark ? 'text-[#919191]' : 'text-gray-600'}`}>
                        ...
                        <div className="flex flex-col md:flex-row">
                            <div className="mb-8 md:mb-0">
                                <h3 className={`font-medium mb-4 ${isDark ? 'text-white' : 'text-gray-800'}`}>Навигация</h3>
