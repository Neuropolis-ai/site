    ...
    <section className="py-20 dark:bg-black bg-white">
      <Container>
        <div className="text-center mb-16">
          <div
            className={`inline-block px-4 py-1 rounded-full switch-box ${
        ...
        <div ref={processRef} className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div
            className={
              isDark ? "p-[22px] process-card" : "p-[22px] light-process-card"
            }
          >
            <div
              className={`w-16 h-16 ${
                isDark ? "bg-blue-900/20" : "bg-blue-100"
              } rounded-lg flex items-center justify-center mb-6 icon-animated ${
                isVisible ? "active" : ""
              }`}
            >
              <svg viewBox="0 0 24 24" width="32" height="32">
                ...
                <path
                  d="M12 3 A9 9 0 0 1 12 21 A9 9 0 0 1 12 3"
                ...
                <circle
                  ...
                  cy="8"
                  r="1.5"
                  className="filled document-text"
            ...
            >
              <svg viewBox="0 0 24 24" width="32" height="32">
                ...
                <circle
                  ...
                  cy="16"
                  r="5"
                  className="filled gear-spin-reverse"
                ...
                <path
                  d="M2 20 L6 20 L6 18 L10 18 L10 22"
                  className="document-line"
                  style={{ animationDelay: "1.5s", strokeWidth: "0.5" }}
                />
                <path
                  d="M22 4 L18 4 L18 8 L14 8 L14 2"
                  className="document-line"
                  style={{ animationDelay: "1.8s", strokeWidth: "0.5" }}
                />
              </svg>
            </div>
            <h3 className="text-base sm:text-lg font-medium dark:text-white text-gray-800 mb-3">
