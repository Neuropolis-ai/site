      ...
      <Container>
        ...
        <div className="flex relative flex-wrap gap-6 z-10">
          <div className="flex flex-col lg:flex-row gap-6 w-full">
            {/* AI Assistant Card */}
            <div
              className={`w-full lg:w-[732px] p-[20px] max-[425px]:p-[12px] rounded-xl overflow-hidden ${
                isDark
                ...
                >
                  ...
                  <div className="flex flex-col">
                    ...
                    >
                      ...
                      >
                        Наша компания может значительно улучшить ваши
                        бизнес-процессы, используя искусственный интеллект и
                        ИИ-агентов для автоматизации рутинных задач и анализа
                        данных.
                      </p>
                    </div>
                  </div>
            ...
            <div
              className={`w-full lg:w-[523px] p-[20px] bg-[#050A1B] rounded-xl border border-[#262626] overflow-hidden  ${
                isDark
                  ? " process-card"
