...
export default function AIAgentSolution() {
  return (
    <section
      id="solution"
                ...
                {[
                  {
                    ...
                    desc: "Агент получает триггер или команду (например, новое письмо, запись в CRM, время по расписанию).",
                  },
                  {
                    num: "02",
                    title: "Анализ и планирование",
                    desc: "ИИ анализирует задачу, данные и определяет последовательность действий.",
                  },
                  {
                    num: "03",
                    title: "Взаимодействие",
                    desc: "Агент подключается к нужным системам, извлекает или вносит информацию.",
                  },
                  {
                    num: "04",
                    title: "Выполнение действия",
                    desc: "Отправляет отчет, отвечает клиенту, обновляет статус заказа и т.д.",
                  },
                  {
                    num: "05",
                    title: "Обучение и отчет",
                    desc: "Запоминает результат, формирует отчет и улучшает свою работу в будущем.",
                  },
                ].map((item, index) => (
                  <motion.div
                    key={item.num}
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5 text-lg text-gray-700 dark:text-gray-300">
                {[
                  {
                    title: "Автономность",
                    desc: "Работают самостоятельно по заданным правилам и целям.",
                  },
                  {
                    title: "Обучаемость",
                    desc: "Способны адаптироваться и улучшать производительность со временем.",
                  },
                  {
                    title: "Интегрируемость",
                    desc: "Легко подключаются к существующим ИТ-системам и API.",
                  },
                  {
                    title: "Масштабируемость",
                    desc: "Способны обрабатывать растущие объемы задач без роста затрат.",
                  },
                  {
                    title: "Работа 24/7",
                    desc: "Выполняют задачи круглосуточно без перерывов и выходных.",
                  },
                ].map((feature, index) => (
                  <motion.div
                    key={feature.title}
                ...
                <div className="relative">
                  ...
                  <div className="space-y-12 pl-8 py-2 relative z-10">
                    {[
                      ...
                      {
                        title: "ИИ-Агент",
                        desc: "Анализ → Доступ к Данным",
                        delay: 0.9,
                        color: "blue",
                      },
                      {
                        title: "Взаимодействие",
                        desc: "CRM, ERP, Базы данных",
                        delay: 1.1,
                        color: "blue",
                      },
                      {
                        title: "Действие",
                        desc: "Ответ, Отчет, Обновление",
                        delay: 1.3,
                        color: "blue",
                      },
                      {
                        title: "Результат",
                        desc: "(Эффективность ↑, Затраты ↓)",
                        delay: 1.5,
                        color: "green",
                      },
                    ].map((step, index) => (
