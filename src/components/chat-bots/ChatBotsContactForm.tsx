          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
              ...
              <div className="h-full flex flex-col">
                ...
                <div className="space-y-6 flex-grow">
                  <div className="flex items-start gap-3">
                    <div className="flex-shrink-0 w-9 h-9 rounded-full bg-blue-100 dark:bg-blue-900/30 flex items-center justify-center text-primary">
                ...
                <div className="mt-8 pt-6 border-t border-gray-200 dark:border-gray-700">
                  ...
                  <div className="flex space-x-3">
                    <a
                      ...
                      className="w-10 h-10 rounded-full flex items-center justify-center bg-blue-100 hover:bg-blue-200 dark:bg-blue-900/30 dark:hover:bg-blue-800/40 text-primary transition-colors"
                    >
            ...
            <motion.div variants={containerVariants} className="lg:col-span-3">
              {isSubmitted ? (
                ...
                >
                  <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-gradient-to-r from-primary to-primary-light text-white mb-6">
                  ...
                  <button
                    ...
                    className="inline-flex items-center justify-center px-6 py-3 border-0 text-lg font-semibold rounded-xl 
                              text-white bg-gradient-to-r from-primary to-primary-light hover:opacity-90 shadow-lg 
                  ...
                  <motion.div variants={itemVariants} className="pt-2">
                    <button
                      ...
                      className={`w-full inline-flex items-center justify-center px-6 py-3 rounded-xl text-lg font-semibold
                        text-white bg-gradient-to-r from-primary to-primary-light hover:opacity-90
