                  ...
                  <div className="p-4 h-[calc(460px-56px)] bg-gray-50 dark:bg-gray-850 overflow-y-auto">
                    ...
                    <div className="flex flex-col space-y-4">
                      ...
                      <div className="flex items-start space-x-2.5">
                        ...
                        <div className="bg-white dark:bg-gray-700 rounded-2xl rounded-tl-none p-3.5 shadow-sm max-w-85p">
                      ...
                      <div className="flex items-start justify-end space-x-2.5">
                        <div className="bg-blue-500 rounded-2xl rounded-tr-none p-3.5 shadow-sm max-w-85p">
