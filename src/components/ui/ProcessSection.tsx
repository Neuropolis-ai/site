    ...
    >
      ...
      <Container>
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-[14px] mb-4 bg-[#0167F3]/10 text-[#0167F3] dark:text-[#399AFC] border border-[#0167F3]/20 dark:border-[#399AFC]/50 backdrop-blur-sm">
            {badge}
          </div>
          <h2 className="text-[36px] font-bold text-gray-900 dark:text-white mb-6 tracking-tight leading-tight">
            Процесс{" "}
