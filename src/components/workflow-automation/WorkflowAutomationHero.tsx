  ...
  return (
    ...
    >
      <div className="absolute inset-0 z-0 opacity-40 dark:opacity-20">
        <div className="absolute -top-32 -right-32 w-96 h-96 bg-gradient-to-br from-purple-200/20 to-purple-400/20 dark:from-purple-500/10 dark:to-purple-700/10 rounded-full blur-3xl"></div>
      ...
      <div className="relative z-20 text-center max-w-[90%] sm:max-w-[85%] md:max-w-[80%] lg:max-w-[900px] mx-auto px-4">
        <motion.div variants={itemVariants}>
          <span className="inline-flex items-center justify-center border border-purple-300 dark:border-purple-800 gap-2 px-4 py-1 rounded-full text-sm mb-4 bg-purple-500/10 text-purple-600 dark:text-purple-400">
            <svg
              width={15}
              height={15}
              viewBox="0 0 15 15"
        ...
        <motion.a
          variants={itemVariants}
          href="#cta"
          className="inline-block w-full sm:w-auto bg-gradient-to-r from-[#8B5CF6] to-[#A78BFA] text-white font-semibold py-4 px-8 rounded-xl text-lg md:text-xl transition-opacity hover:opacity-90 shadow-xl"
        >
